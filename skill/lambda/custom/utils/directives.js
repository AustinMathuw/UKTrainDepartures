...
var timetableTemplate = require('../apl/timetableTemplate.json');
var defaultTemplate = require('../apl/defaultTemplate.json');

// Alexa Presentation Language (APL) Directives
const APL = {
  // returns a RenderDocument directive for either correct or incorrect song guess
  setTimetableDisplay: function (trains, backgroundImage, skillTitle, logoUrl, hintText) {
    let data = {
    ...
    return {
      ...
      "version": '1.0',
      "document": timetableTemplate.document,
      "datasources": {data}
    };
  },
